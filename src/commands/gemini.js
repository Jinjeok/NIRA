            ...
            try {
                ...
                try {
                    ...
                    if (PERSONA_PROMPTS[personaChoice]) {
                        config.config.systemInstruction = PERSONA_PROMPTS[personaChoice];
                    }
                    if (modelChoice === 'pro') {
                        config.config = {
                            ...config.config,
                    ...
                    if (PERSONA_PROMPTS[personaChoice]) {
                        fallbackConfig.config.systemInstruction = PERSONA_PROMPTS[personaChoice];
                    }
